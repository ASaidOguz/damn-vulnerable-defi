...
describe('[Challenge] The rewarder', function () {
    ...
    it('Execution', async function () {
        ...
        const attackerCon=await hre.ethers.getContractFactory("AttackRewarder",player);
       const attackContract= await attackerCon.deploy(rewarderPool.address,flashLoanPool.address,liquidityToken.address,rewardToken.address)
